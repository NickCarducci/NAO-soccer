...
DEFAULT_PROMPT = "What? You didn't say anything containing 'good', 'bad', nor 'so-so'"
RESPONSES = {
...
try:
    ...
    speech.pause(False)
    speech.subscribe("listen_to_me_2")

    sound.setParameter("Sensitivity", 0.6)
    sound.subscribe("listen_to_me_sound_2")
    ...
    try:
        speech.unsubscribe("listen_to_me_2")
    except Exception:
        pass
    try:
        sound.unsubscribe("listen_to_me_sound_2")
    except Exception:
        pass
